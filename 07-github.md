...
![The Local Repository with Git Staging Area](https://github.com/swcarpentry/git-novice/blob/gh-pages/fig/git-staging-area.svg)

Now that we have two repositories, we need a diagram like this:

![Freshly-Made GitHub Repository](https://github.com/swcarpentry/git-novice/blob/gh-pages/fig/git-freshly-made-github-repo.svg)
...
![Where to Find Repository URL on GitHub](https://github.com/swcarpentry/git-novice/blob/gh-pages/fig/github-find-repo-string.png)
...
![Changing the Repository URL on GitHub](https://github.com/swcarpentry/git-novice/blob/gh-pages/fig/github-change-repo-string.png)
